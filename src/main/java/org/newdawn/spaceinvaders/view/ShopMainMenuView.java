...
/**
 * 주 상점 화면에 표시될 메뉴를 구현한 클래스.
 * "캐릭터 강화", "아이템 뽑기" 등의 선택지를 제공하는 수직 메뉴입니다.
 */
public class ShopMainMenuView implements Menu {
    /** 메뉴에 표시될 항목들. */
    private final String[] items = {"캐릭터 강화", "아이템 뽑기", "뒤로가기"};
    /** 현재 선택된 항목의 인덱스. */
    ...
    public void moveLeft() {
        throw new UnsupportedOperationException("moveLeft is not supported in ShopMainMenuView");
    }
    ...
    public void moveRight() {
        throw new UnsupportedOperationException("moveRight is not supported in ShopMainMenuView");
    }
